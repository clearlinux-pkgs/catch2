...
Source0  : https://github.com/catchorg/Catch2/archive/v3.7.0/Catch2-3.7.0.tar.gz
...
%prep
%setup -q -n Catch2-3.7.0
cd %{_builddir}/Catch2-3.7.0
pushd ..
cp -a Catch2-3.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724169571
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libCatch2.so.3.7.0
/V3/usr/lib64/libCatch2Main.so.3.7.0
/usr/lib64/libCatch2.so.3.7.0
/usr/lib64/libCatch2Main.so.3.7.0
