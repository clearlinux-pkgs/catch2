...
Version  : 3.5.0
Release  : 7
URL      : https://github.com/catchorg/Catch2/archive/v3.5.0/Catch2-3.5.0.tar.gz
Source0  : https://github.com/catchorg/Catch2/archive/v3.5.0/Catch2-3.5.0.tar.gz
...
%prep
%setup -q -n Catch2-3.5.0
cd %{_builddir}/Catch2-3.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707074171
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libCatch2.so.3.5.0
/V3/usr/lib64/libCatch2Main.so.3.5.0
/usr/lib64/libCatch2.so.3.5.0
/usr/lib64/libCatch2Main.so.3.5.0
