...
Source0  : https://github.com/catchorg/Catch2/archive/v3.4.0/catch2-3.4.0.tar.gz
...
%prep
%setup -q -n Catch2-3.4.0
cd %{_builddir}/Catch2-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699914040
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libCatch2.so.3.4.0
/usr/lib64/libCatch2Main.so.3.4.0
