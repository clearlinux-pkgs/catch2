...
Version  : 3.8.0
Release  : 39
URL      : https://github.com/catchorg/Catch2/archive/v3.8.0/Catch2-3.8.0.tar.gz
Source0  : https://github.com/catchorg/Catch2/archive/v3.8.0/Catch2-3.8.0.tar.gz
...
%prep
%setup -q -n Catch2-3.8.0
cd %{_builddir}/Catch2-3.8.0
pushd ..
cp -a Catch2-3.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736176753
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libCatch2.so.3.8.0
/V3/usr/lib64/libCatch2Main.so.3.8.0
