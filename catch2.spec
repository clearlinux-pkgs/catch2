...
Version  : 3.7.1
Release  : 38
URL      : https://github.com/catchorg/Catch2/archive/v3.7.1/Catch2-3.7.1.tar.gz
Source0  : https://github.com/catchorg/Catch2/archive/v3.7.1/Catch2-3.7.1.tar.gz
...
%prep
%setup -q -n Catch2-3.7.1
cd %{_builddir}/Catch2-3.7.1
pushd ..
cp -a Catch2-3.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727476199
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libCatch2.so.3.7.1
/V3/usr/lib64/libCatch2Main.so.3.7.1
/usr/lib64/libCatch2.so.3.7.1
/usr/lib64/libCatch2Main.so.3.7.1
